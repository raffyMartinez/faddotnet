namespace FAD3
{
    partial class GraticuleForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Controls.Add(this.txtGridlineWidth);
            this.Controls.Add(this.txtBordeWidth);
            this.Controls.Add(this.txtNumberOfGridlines);
            this.Controls.Add(this.txtLabelSize);
