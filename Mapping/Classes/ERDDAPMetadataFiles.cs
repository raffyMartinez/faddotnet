...
namespace FAD3.Mapping.Classes
{
    ...
    /// </summary>
    public static class ERDDAPMetadataFiles
    {
        public static EventHandler<ERDDAPMetadataFile> OnMetadataRead;
        ...
        public static Dictionary<string, ERDDAPMetadataFile> MetadataFiles = new Dictionary<string, ERDDAPMetadataFile>();
        ...
        public static int ReadISO9115Metadata()
        {
            ...
            if (files.Length > 0)
            {
                ...
                for (int n = 0; n < files.Length; n++)
                {
                    ...
                    var erd = new ERDDAPMetadataFile(dataTitle, dataAbstract, beginPosition, endPosition, identifier, url, credit, temporalSize, new Dictionary<string, (string unit, string description)>(_parameters), files[n]);
                    ...
                    MetadataFiles.Add(identifier, erd);
        ...
        public static void UpdateMetadataEndPosition(string identifier, string updateEndPosition)
        {
            MetadataFiles[identifier].EndPosition = DateTime.Parse(updateEndPosition);
        }
