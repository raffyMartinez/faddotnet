...
namespace FAD3.Mapping.UserControls
{
    public partial class ListControl : UserControl
    {
        ...
        private bool _resizeNeeded = true;  // the control's layout should be recalculated in the next OnPaint event
        private bool _redrawNeeded = true;  // the control's items should be redrawn in the next OnPaint event
